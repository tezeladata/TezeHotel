        ...
        <section className="sticky top-0 z-50">
            ...
            <div className={`relative bg-main-light px-[15%]  flex items-center justify-between max-[1000px]:px-[7.5%] max-[900px]:text-xs max-[900px]:block`}>
                ...
                >
                    ...
                    <span className="shadow-[0px_0px_11px_5px_rgba(138,129,64,1)] rounded-xl text-main-light ml-6 my-2 pt-1.5 pb-1.5 pl-3 pr-3 bg-main-gold cursor-pointer hover:font-bold max-[500px]:w-max max-[500px]:[grid-area:4/1/5/3] max-[500px]:justify-self-center max-[500px]:mx-0">Book now</span>
                </div>
            </div>
        </section>
    );
